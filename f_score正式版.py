...
Original file is located at
    https://colab.research.google.com/drive/1drKdNslZ_uQ_jcHn7FmzCTTBcr6sCKR1
"""
...
for i in range(1, 12): #11個季度為樣本內資料
  data = pd.read_csv("/content/drive/MyDrive/F_score/a/"+str(i)+".csv", index_col='code')
  ...
  train_set = train_set.apply(pd.to_numeric, errors='coerce')
  train_set = train_set.dropna()
  train_set = train_set[(train_set['F']==group1)|(train_set['F']==group2)]

  company = list(train_set.index)

  data_ret = pd.read_csv("/content/drive/MyDrive/F_score/b/"+str(i+1)+".csv", index_col='t')
  try:
